      ...
      <main className="max-w-6xl mx-auto px-6 py-16">
        <div className="mb-10">
          ...
          <p className="mt-2 text-sm" style={{ color: "#6b7a99" }}>
            Your psychographic fit profile and coaching insights.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
          {[
            { label: "Fit Score", value: "—", note: "Coming in Phase 2" },
            { label: "Dimensions Scored", value: "6", note: "Survey complete" },
            { label: "Coaching Items", value: "—", note: "Coming in Phase 2" },
          ].map((card) => (

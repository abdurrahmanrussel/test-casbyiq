...
const agentIntake: Q[] = [
  ...
  { id: "CTX_A1", text: "Years licensed", role: "agent", surveyType: "agent_intake", section: "1B", questionType: "multiple_choice", isScored: false, options: ["Less than 1 year", "1–2 years", "3–5 years", "6–10 years", "10+ years"], required: true, sortOrder: 37, storageTarget: "raw_json" },
